<footer class="container mx-auto p-4 text-sm border-t flex justify-between items-center">
    ...
    @env('local')
    <div class="p-2" x-data="{ showIcons: false }" @click="showIcons = true">
        ...
        <div class="fixed left-0 right-0 bottom-12 p-2 mx-2 sm:mx-8
            ...
            <x-layout.footer.icon target="_myadmin" href="http://phpmyadmin.test" icon="si-phpmyadmin" />
            <x-layout.footer.icon target="_mail" href="http://localhost:8025" icon="si-maildotru" />
            <x-layout.footer.icon target="_icons" href="https://blade-ui-kit.com/blade-icons" icon="fas-icons" />
            <x-layout.footer.icon target="_tall" href="https://tailwindcss.com/docs" icon="si-tailwindcss" />
            <x-layout.footer.icon target="_tall" href="https://alpinejs.dev/" icon="si-alpinedotjs" />
            <x-layout.footer.icon target="_tall" href="https://laravel.com/docs/9.x/" icon="si-laravel" />
            <x-layout.footer.icon target="_tall" href="https://laravel-livewire.com/docs/2.x/" icon="si-livewire" />
        </div>
    </div>
    @endenv
